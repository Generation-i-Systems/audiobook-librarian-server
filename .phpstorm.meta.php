...
'app.cipher','app.key','app.previous_keys','app.maintenance.providers','app.maintenance.driver',
'app.maintenance.store','app.providers','app.aliases.File','app.aliases.Auth','app.aliases.Queue',
'app.book_root','app.library_repair_sync_path','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
'auth.guards.web.provider','auth.guards.api.driver','auth.guards.api.provider','auth.guards.api.hash','auth.guards.api_test.driver',
'auth.guards.api_test.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.documentstore.driver','auth.providers.documentstore.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
'auth.passwords.users.throttle','auth.password_timeout','bookparser.extensions','bookparser.min_file_size','bookparser.max_depth',
'bookparser.local_metadata_filename','bookparser.exclude_dirs','bookparser.default_output_format','bookparser.default_output_path','bookparser.database_table',
'bookparser.metadata_fields.title','bookparser.metadata_fields.author','bookparser.metadata_fields.series','bookparser.metadata_fields.series_number','bookparser.metadata_fields.narrator',
'bookparser.metadata_fields.edition','bookparser.metadata_fields.year','bookparser.metadata_fields.genre','bookparser.metadata_fields.path','bookparser.metadata_fields.filename',
'bookparser.metadata_fields.file_extension','bookparser.metadata_fields.file_size','bookparser.metadata_fields.file_modified','bookparser.metadata_fields.full_path','cache.default',
...
'database.connections.sqlite.synchronous','database.connections.sqlite.options','database.connections.mysql.driver','database.connections.mysql.url','database.connections.mysql.host',
...
'database.connections.testing.database','database.connections.testing.prefix','database.connections.testing.foreign_key_constraints','database.connections.testing.busy_timeout','database.connections.testing.journal_mode',
'database.connections.testing.synchronous','database.connections.testing.options','database.connections.mysql_testing.driver','database.connections.mysql_testing.url','database.connections.mysql_testing.host',
'database.connections.mysql_testing.port','database.connections.mysql_testing.database','database.connections.mysql_testing.username','database.connections.mysql_testing.password','database.connections.mysql_testing.unix_socket',
'database.connections.mysql_testing.charset','database.connections.mysql_testing.collation','database.connections.mysql_testing.prefix','database.connections.mysql_testing.prefix_indexes','database.connections.mysql_testing.strict',
'database.connections.mysql_testing.engine','database.connections.mysql_testing.options','database.connections.mongodb.driver','database.connections.mongodb.dsn','database.connections.mongodb.database',
...
'documentstore.driver','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.books.driver','filesystems.disks.books.root',
'filesystems.disks.books.throw','filesystems.disks.books.report','filesystems.disks.trash.driver','filesystems.disks.trash.root','filesystems.disks.trash.throw',
'filesystems.disks.trash.report','filesystems.disks.covers.driver','filesystems.disks.covers.root','filesystems.disks.covers.url','filesystems.disks.covers.visibility',
'filesystems.disks.covers.throw','filesystems.disks.skins.driver','filesystems.disks.skins.root','filesystems.disks.skins.visibility','filesystems.disks.skins.throw',
'filesystems.disks.skins.report','filesystems.disks.skin_previews.driver','filesystems.disks.skin_previews.root','filesystems.disks.skin_previews.url','filesystems.disks.skin_previews.visibility',
'filesystems.disks.skin_previews.throw','filesystems.disks.skin_previews.report','filesystems.links./home/eric-22/src/audiobook-librarian-server/public/storage','genres.list','hardcover.api_url',
'hardcover.api_token','hardcover.token_expires_at','hardcover.notification_email','horizon.name','horizon.domain',
...
'horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','import.roots','import.allowed_extensions','logging.default',
...
'logging.channels.daily.path','logging.channels.daily.level','logging.channels.daily.days','logging.channels.daily.replace_placeholders','logging.channels.daily.permission',
'logging.channels.daily.locking','logging.channels.slack.driver','logging.channels.slack.url','logging.channels.slack.username','logging.channels.slack.emoji',
...
'logging.channels.testing.driver','logging.channels.testing.path','logging.channels.testing.level','logging.channels.testing.replace_placeholders','logging.channels.failed_books.driver',
'logging.channels.failed_books.path','logging.channels.failed_books.level','logging.channels.audit_trail.driver','logging.channels.audit_trail.path','logging.channels.audit_trail.level',
'logging.channels.audit_trail.days','logging.channels.safe_fallback.driver','logging.channels.safe_fallback.channels','logging.channels.safe_fallback.ignore_exceptions','logging.channels.deprecations.driver',
...
'mail.mailers.ses_smtp.transport','mail.mailers.ses_smtp.scheme','mail.mailers.ses_smtp.url','mail.mailers.ses_smtp.host','mail.mailers.ses_smtp.port',
'mail.mailers.ses_smtp.username','mail.mailers.ses_smtp.password','mail.mailers.ses_smtp.timeout','mail.mailers.ses_smtp.local_domain','mail.from.address',
'mail.from.name','mail.markdown.theme','mail.markdown.paths','memory_optimization.pagination_limits.admin_books','memory_optimization.pagination_limits.public_books',
'memory_optimization.pagination_limits.recent_books','memory_optimization.pagination_limits.related_books','memory_optimization.relationship_limits.authors_per_book','memory_optimization.relationship_limits.genres_per_book','memory_optimization.relationship_limits.series_per_book',
'memory_optimization.memory_thresholds.warning','memory_optimization.memory_thresholds.critical','memory_optimization.aggressive_optimization','mongodb.uri','mongodb.database',
...
'services.mailgun.domain','services.mailgun.secret','services.mailgun.endpoint','services.mailgun.scheme','services.cdn.enabled',
'services.cdn.url','services.cdn.path','services.cdn.cache_ttl','services.google.client_id','services.google.client_secret',
'services.google.redirect','services.google.api_key','services.google.search_engine_id','services.googlebooks.key','services.audiobook_bay.base_url',
'services.audiobook_bay.username','services.audiobook_bay.password','services.audiobook_bay.user_agent','services.gemini.api_key','services.gemini.model',
'services.gemini.timeout','services.gemini.paid_tier','services.claude.api_key','services.claude.model','services.claude.timeout',
'services.claude.paid_tier','services.openai.api_key','services.openai.model','services.openai.timeout','services.openai.paid_tier',
'services.openai.organization','services.ai.default_model','services.ai.default_provider','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','testing.database.default',
'testing.database.connections.sqlite.driver','testing.database.connections.sqlite.database','testing.database.connections.sqlite.prefix','testing.database.connections.sqlite.foreign_key_constraints','ide-helper.filename',
...
'signed','throttle','verified','admin','standard',
'library','active','api.auth',);
...
'sanctum.csrf-cookie','api.books.downloadFile','api.favorites.index','api.favorites.store','api.favorites.show',
'api.favorites.update','api.favorites.destroy',
'emergency.books.index',
'login','logout','register',
'password.request','password.email','password.reset','password.update','password.confirm','login.google','home','docs.index',
'docs.openapi','docs.show','api-docs.openapi','my-library.queue','my-library.wishlist',
'my-library.recommendations','my-library.history','my-library.goals','books.index','books.show',
'books.create','books.download','books.play','reviews.store','reviews.destroy',
'favorites.index','favorites.store','favorites.destroy','favorites.toggle-notifications','follow',
'unfollow','reading_progress.update','reading_progress.get','profile.index','profile.update',
'profile.changePassword','profile.requestAdminPermissions','messages.store','csrf.token','api.books.json',
'api.books.recent.json','books.set-preference','image.proxy','cover.proxy','google.books.cover.proxy',
'admin.series.autocomplete','gallery.skins.index','gallery.skins.create','gallery.skins.store','gallery.skins.my-skins',
'gallery.skins.show','gallery.skins.edit','gallery.skins.update','gallery.skins.destroy','gallery.skins.fork',
'gallery.skins.rate','gallery.themes.index','gallery.themes.create','gallery.themes.store','gallery.themes.my-themes',
'gallery.themes.show','gallery.themes.edit','gallery.themes.update','gallery.themes.destroy','gallery.themes.fork',
'gallery.themes.rate','admin.social.index','admin.adminer','admin.database','admin.',
'admin.needs_review.index','admin.library-repair.index','admin.library-repair.resolve','admin.library-repair.rescan','admin.library-repair.import-missing',
'admin.library-repair.refresh','admin.books.resyncFromPath','admin.ai-query.process','admin.ai-query.results','admin.ai-query.apply-bulk-update',
'admin.ai-query.execute-custom','admin.ai-query.edit-prompt','admin.ai-query.refine-item','admin.ai-query.tools.process','admin.ai-query.tools.history',
'admin.ai-query.tools.details','admin.ai-assistant.index','admin.ai-assistant.process','admin.ai-assistant.session','admin.ai-assistant.execute',
'admin.ai-assistant.refine','admin.ai-assistant.cancel','admin.ai-assistant.history','admin.ai-assistant.stats','admin.directory-validation',
'admin.directory-validation.rescan','admin.directory-validation.rename','admin.directory-validation.delete-book','admin.directory-validation.import','admin.directory-validation.delete-orphan',
'admin.directory-validation.rename-orphan','admin.users.updateRole','admin.books.import','admin.books.importFile','admin.import.roots',
'admin.import.list','admin.import.extract','admin.import.extract.ai','admin.import.move','admin.books.search',
'admin.books.googleBooks','admin.books.audible','admin.authors.ajax','admin.series.ajax','admin.import.rename',
'admin.books.filesAjax','admin.books.extract-embedded-cover','admin.books.audioMetadata','admin.books.browseDirectories','admin.books.renameSeries',
'admin.books.checkDirectoryConflict','admin.books.buildPathFromFields','admin.books.executeImmediateMove','admin.books.plannedActions','admin.genres.authors',
'admin.genres.merge','admin.authors.browse','admin.authors.merge','admin.genres.index','admin.genres.create',
'admin.genres.store','admin.genres.show','admin.genres.edit','admin.genres.update','admin.genres.destroy',
'admin.authors.index','admin.authors.create','admin.authors.store','admin.authors.show','admin.authors.edit',
'admin.authors.update','admin.authors.destroy','admin.books.index','admin.books.create','admin.books.store',
'admin.books.show','admin.books.edit','admin.books.update','admin.books.destroy','admin.books.rawJson',
'admin.books.saveRawJson','admin.books.autocomplete.authors','admin.books.autocomplete.series','admin.books.autocomplete.narrators','admin.books.autocomplete.genres',
'admin.books.parsePath','admin.series.manage','admin.series.merge','admin.series.rename','admin.series.edit',
'admin.series.update','admin.series.destroy','admin.account_requests.index','admin.account_requests.create','admin.account_requests.store',
'admin.account_requests.show','admin.account_requests.edit','admin.account_requests.update','admin.account_requests.destroy','admin.books.importFromTitle',
'admin.books.importFromGoogleBooks','admin.books.processImport','admin.directoryBrowser','admin.books.bulkImport','admin.books.bulkImportDir',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.users.verify','admin.queue.index','admin.',
'admin.','admin.','admin.','admin.queue.clear','admin.horizon',
'admin.messages.index','admin.messages.create','admin.messages.store','admin.messages.markAsRead','admin.send.notification',
'admin.messages.acknowledge','admin.jobs.index','admin.jobs.show','admin.jobs.retry','admin.jobs.cancel',
'admin.jobs.cleanup','admin.jobs.logs','admin.jobs.output','admin.jobs.errors','admin.trash.index',
'admin.trash.restore','admin.trash.destroy','admin.trash.destroyAll','admin.trash.cleanup','storage.local',);
        registerArgumentsSet('views', 
'admin.account_requests.index','admin.ai-assistant.index','admin.ai-assistant.session','admin.ai-query.partials.bulk-update-results','admin.ai-query.partials.bulk-update-row',
'admin.ai-query.partials.list-results','admin.ai-query.partials.parse-update-results','admin.ai-query.partials.research-results','admin.ai-query.results','admin.authors.browse',
'admin.authors.create','admin.authors.edit','admin.authors.index','admin.books.create','admin.books.create_form',
'admin.books.edit','admin.books.form','admin.books.import','admin.books.import_directory','admin.books.import_file',
'admin.books.import_file_browser','admin.books.import_from_title','admin.books.index','admin.books.index_minimal','admin.books.partials.directory_row',
'admin.books.search_results','admin.books.show','admin.database','admin.directory-validation','admin.genres.authors',
'admin.genres.create','admin.genres.edit','admin.genres.index','admin.index','admin.jobs.index',
'admin.jobs.show','admin.library-repair.index','admin.messages.create','admin.messages.index','admin.messages.show',
'admin.needs_review.index','admin.queue.index','admin.series.edit','admin.series.manage','admin.social.index',
'admin.trash.index','admin.users.create','admin.users.edit','admin.users.index','auth.login',
'auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register','auth.verify',
'books.emergency_error','books.emergency_index','books.index','books.search_results','books.show',
'components.ai-query-prompt','components.layout','docs.viewer','emails.hardcover.token-expiring','emails.new-favorite-books',
'emails.users.new-registration','favorites.index','gallery.skins.create','gallery.skins.index','gallery.skins.show',
'gallery.themes.create','gallery.themes.index','gallery.themes.show','home','layouts.app',
'layouts.modal','pagination.admin-books','player.show','profile.index','queue.index',
'user.library.goals','user.library.history','user.library.queue','user.library.recommendations','user.library.wishlist',
...
'DB_PASSWORD','DOCUMENT_STORE_DRIVER','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
...
'REDIS_PORT','BOOK_STORAGE_PATH','DELETED_BOOKS_PATH','TRASH_AUTO_CLEANUP_DAYS','MAIL_MAILER',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','MONGODB_URI','MONGODB_DB','GOOGLE_BOOKS_API_KEY',
'VITE_APP_NAME','AUDIOBOOK_BAY_USERNAME','AUDIOBOOK_BAY_PASSWORD','AUDIOBOOK_BAY_RATE_LIMIT','AUDIOBOOK_BAY_BASE_URL',
'HARDCOVER_API_KEY','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','GEMINI_API_KEY',
'GEMINI_MODEL','GEMINI_TIMEOUT','OPENAI_API_KEY','SES_SMTP_USER','SES_SMTP_PASS',
'SES_SMTP_HOST','SES_SMTP_PORT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',
'QUEUE_CONNECTION','CACHE_STORE','SESSION_SAME_SITE','SESSION_SECURE_COOKIE',);
