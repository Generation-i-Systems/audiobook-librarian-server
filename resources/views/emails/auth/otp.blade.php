        ...
        <tr>
            <td align="center">
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:520px; background:#ffffff; border-radius:12px; padding:32px;">
                    <tr>
                        <td>
                            <h1 style="margin:0 0 12px 0; font-size:20px; color:#1a1a1a;">Sign in to {{ $appName }}</h1>
                            <p style="margin:0 0 20px 0; font-size:14px; color:#444; line-height:1.5;">
                                ...
                                @else
                                    Hi,
                                @endif
                                use the code below or click the button to sign in. This code expires in {{ $ttlMinutes }} minutes and can only be used once.
                            </p>
