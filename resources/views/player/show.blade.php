                ...
                <div class="col-12">
                    ...
                    <audio id="audioPlayer" preload="metadata" class="d-none">
                        @if(count($audioFiles) > 0)
                            <source src="{{ route('api.books.downloadFile', ['book' => $book['id'], 'file' => basename($audioFiles[0]['path'])]) }}" type="audio/mpeg">
                        @endif
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="playbackRate" class="form-label">Playback Speed: <span id="rateDisplay">1.0x</span></label>
                            <input type="range" class="form-range" id="playbackRate" min="0.5" max="2.0" step="0.1" value="1.0">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="fileSelector">
                                @foreach($audioFiles as $index => $file)
                                    <option value="{{ $index }}" data-url="{{ route('api.books.downloadFile', ['book' => $book['id'], 'file' => basename($file['path'])]) }}">
