                        ...
                        <div class="card border-danger mb-4">
                            ...
                            <div class="card-body">
                                ...
                                @if(isset($job['error']['trace']))
                                    <h6>Stack Trace</h6>
                                    <pre class="bg-light p-3 rounded" style="max-height: 300px; overflow: auto;">{{ $job['error']['trace'] }}</pre>
                                @endif

                                @if(isset($job['error']['file']) && isset($job['error']['line']))
                                    <div class="mt-3">
                                        <span class="text-muted">In file:</span> {{ $job['error']['file'] }}:{{ $job['error']['line'] }}
                                    </div>
                                @endif
                            </div>
                        </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if(isset($log['context']) && !empty($log['context']))
                                                            <div class="text-muted small mt-1">
                                                                <pre class="mb-0">{{ json_encode($log['context'], JSON_PRETTY_PRINT) }}</pre>
                                                            </div>
                                                        @endif
                                                    </td>
                                                </tr>
