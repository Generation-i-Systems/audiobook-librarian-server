...
@section('content')
    <div class="container">
        ...
        <div class="list-group">
            <a href="{{ route('genres.index') }}" class="list-group-item list-group-item-action">Manage Genres</a>
            <a href="{{ route('authors.index') }}" class="list-group-item list-group-item-action">Manage Authors</a>
