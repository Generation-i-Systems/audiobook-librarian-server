...
if (isset($_GET["mongo"])) {
    ...
    if (class_exists('MongoDB\Driver\Manager')) {
        class Db extends SqlDb
        {
            ...
            public function attach($server, $username, $password): string
            {
                $options = array();
        ...
        class Result
        {
            ...
            public function fetch_field(): \stdClass
            {
    ...
    {
        public static $extensions = array("mongodb");
        ...
        public function select($table, array $select, array $where, array $group, array $order = array(), $limit = 1, $page = 0, $print = false)
        {
            $select = (
                $select == array("*")
                ? array()
