...
return [
    ...
    'profiles' => [
        ...
        'librivox' => [
            ...
            'database_connection' => env('LIBRARY_PROFILE_LIBRIVOX_DB_CONNECTION', env('DB_CONNECTION', 'sqlite')),
            'book_storage_path' => env(
                'LIBRARY_PROFILE_LIBRIVOX_BOOK_STORAGE_PATH',
                rtrim($defaultBookStoragePath, '/') . '/librivox-cache'
            ),
