...
function initBookForm($container) {
    ...
    $container
        ...
        .on("click", ".add-author-row", function (e) {
            e.preventDefault();
    ...
    $container
        ...
        .on("click", ".add-series-row", function (e) {
            e.preventDefault();
...
const createFormHtml = (isModal = false) => {
    ...
    if (isModal) {
        return `<div class="modal fade" id="bookModal" tabindex="-1" aria-hidden="true">
...
describe("Book Form", () => {
    ...
    describe("Directory and File Operations", () => {
                        ...
                        files: [
                            {
                                ...
                                type: "file",
                                size: 1024 * 1024,
                                path: "/test/path/book1.mp3",
                            },
                            {
                                name: "book2.mp3",
                                type: "file",
                                size: 2 * 1024 * 1024,
                                path: "/test/path/book2.mp3",
                            },
                            {
                                name: "cover.jpg",
                                type: "file",
                                size: 500 * 1024,
                                path: "/test/path/cover.jpg",
                            },
                            {
                                name: "subfolder",
                                type: "dir",
        ...
        test("should show directory contents when directory is selected", (done) => {
            ...
            setTimeout(() => {
                const fileItems = $("#directory-files-list").find(
                    ".list-group-item",
                );
                ...
                expect(fileItems.eq(0).find(".badge").text()).toContain(
                    "1.0 MB",
                );

                // Check folder item
                expect(fileItems.eq(3).text()).toContain("subfolder");
                expect(fileItems.eq(3).find(".badge").text()).toContain(
                    "Folder",
                );
        ...
        test("should filter files by type when filter is applied", (done) => {
            ...
            $("body").append(
                ` < div class = "btn-group mb-3" role = "group" > < button type = "button" class = "btn btn-outline-secondary active" data - filter = "all" > All < / button > < button type = "button" class = "btn btn-outline-secondary" data - filter = "audio" > Audio < / button > < button type = "button" class = "btn btn-outline-secondary" data - filter = "image" > Images < / button > < / div > `,
            );
            ...
            setTimeout(() => {
                ...
                expect($(".list-group-item:visible:first").text()).toContain(
                    ".mp3",
                );
    ...
    describe("Book Management", () => {
        beforeEach(() => {
            ...
            $.ajax = jest
                .fn()
                .mockImplementation(({ url, type, data, success }) => {
                    if (type === "POST" && url.includes("books")) {
                        ...
                        success({
                            ...
                            book: {
                                ...
                                series: data.series_names
                                    ? data.series_names[0]
                                    : null,
                                series_number: data.series_numbers
                                    ? data.series_numbers[0]
                                    : null,
        ...
        test("should create a new book with valid data", (done) => {
            ...
            setTimeout(() => {
                ...
                expect($(".alert-success").text()).toContain(
                    "saved successfully",
                );
        ...
        test("should handle form submission errors", (done) => {
            ...
            setTimeout(() => {
                ...
                expect($(".invalid-feedback").text()).toContain(
    ...
    testInBothModes("Form Submission", (mode) => {
        test("should validate required fields", () => {
            ...
            expect($("#title").hasClass("is-invalid")).toBe(true);
            expect(
                $(".author-autocomplete").first().hasClass("is-invalid"),
            ).toBe(true);
        });
        ...
        test("should submit form with valid data", () => {
            ...
            const authorField = formData.find(
