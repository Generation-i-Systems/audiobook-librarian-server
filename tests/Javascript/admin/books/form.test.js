        ...
        <form id="book-form" ${isModal ? 'data-modal-form="true"' : ''}>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="directory_path" class="form-control">
...
describe('Book Form', () => {
    ...
    describe('Directory and File Operations', () => {
        ...
        test('should handle AJAX errors when loading directory', (done) => {
            ...
            $('#directory_path').val('/invalid/path');
            $('#show-files-link').click();
    ...
    describe('Book Management', () => {
        ...
        test('should create a new book with valid data', (done) => {
            ...
            $('#directory_path').val('/test/books/test-book');
        ...
        test('should update an existing book', (done) => {
            ...
            $('#directory_path').val('/test/books/updated-book');
            $('#published_year').val('2023');
