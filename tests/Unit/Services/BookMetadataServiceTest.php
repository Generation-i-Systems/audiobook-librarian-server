...
class BookMetadataServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new BookMetadataService();
    }

    /** @test */
    public function it_saves_and_loads_metadata_locally()
    {
    ...
    /** @test */
    public function it_handles_missing_metadata_file()
    {
    ...
    /** @test */
    public function it_generates_consistent_book_ids()
    {
        $path1 = '/path/to/book';
        $path2 = '/path/to/book';
    ...
    /** @test */
    public function it_handles_invalid_metadata()
    {
