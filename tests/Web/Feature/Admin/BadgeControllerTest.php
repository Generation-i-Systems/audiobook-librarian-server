...
#[CoversClass(\App\Http\Controllers\Admin\BadgeController::class)]
class BadgeControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $adminUser = new DocumentstoreUser([
            'id' => 'admin-user',
            'name' => 'Test Admin',
    ...
    public function indexRendersSuccessfully(): void
    {
        ...
        $this->get(route('admin.badges.index'))->assertOk()->assertSee('Index View Badge');
    }

    #[Test]
    public function createRendersSuccessfully(): void
    {
        $this->get(route('admin.badges.create'))->assertOk()->assertSee('Create New Badge');
    }
    ...
    public function editRendersSuccessfully(): void
    {
        ...
        $this->get(route('admin.badges.edit', $badge))->assertOk()->assertSee('Edit Badge: Edit View Badge');
    }

    #[Test]
    public function storeCreatesBadgeWithMultiConditionCriteria(): void
    {
        $response = $this->post(route('admin.badges.store'), [
            'key' => 'test_badge',
            'name' => 'Test Badge',
    ...
    public function destroyDeactivatesRatherThanDeletingBadge(): void
    {
        ...
        $response = $this->delete(route('admin.badges.destroy', $badge));
    ...
    public function forceDestroyIsBlockedWhenBadgeHasBeenEarned(): void
    {
        ...
        $response = $this->delete(route('admin.badges.forceDestroy', $badge));
    ...
    public function activateReactivatesADeactivatedBadge(): void
    {
        ...
        $response = $this->post(route('admin.badges.activate', $badge));
