...
{
    protected $signature = 'books:repair-no-audio {parent_path?} {--delete : Delete books with no audio files} {--interactive : Interactively review each book with no audio files}';
