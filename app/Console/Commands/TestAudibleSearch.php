        ...
        try {
            ...
            foreach ($results as $index => $book) {
                ...
                if (!empty($book['publisher'])) {
                    $publisher = is_array($book['publisher']) && isset($book['publisher']['name']) ? $book['publisher']['name'] : (is_array($book['publisher']) ? implode(', ', $book['publisher']) : $book['publisher']);
                ...
                if (!empty($book['cover_image_url'])) {
                    $coverImage = is_array($book['cover_image_url']) ? implode(', ', $book['cover_image_url']) : $book['cover_image_url'];
