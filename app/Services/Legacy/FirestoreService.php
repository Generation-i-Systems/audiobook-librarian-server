...
class FirestoreService implements DocumentStoreServiceInterface
{
                    ...
                    if ($createdDateTime >= $daysAgo) {
                        ...
                        if (isset($bookData['release_date'])) {
                            if ($bookData['release_date'] instanceof Timestamp) {
                                $releaseDate = $bookData['release_date']->get()->format('Y-m-d');
                                $bookData['year'] = (int)substr($releaseDate, 0, 4);
                            } elseif (is_string($bookData['release_date'])) {
     ...
     * @return array Array of matching genres
     */
